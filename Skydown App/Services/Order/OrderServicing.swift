...
final class FirebaseOrderService: OrderServicing {
    ...
    private func mapOrder(document: QueryDocumentSnapshot) -> Order? {
        ...
        return Order(
            ...
            paymentProvider: (data["paymentProvider"] as? String)?.takeIfNotBlank(),
            paymentStatus: data["paymentStatus"] as? String,
            paymentReference: (data["paymentReference"] as? String)?.takeIfNotBlank(),
            ...
            stripeCheckoutSessionId: (data["stripeCheckoutSessionId"] as? String)?.takeIfNotBlank(),
            stripePaymentIntentId: (data["stripePaymentIntentId"] as? String)?.takeIfNotBlank(),
            stripeCheckoutStatus: (data["stripeCheckoutStatus"] as? String)?.takeIfNotBlank(),
