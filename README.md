...
| Android | `applicationId` `com.nash.skyos`, `versionCode` `10022`, SDK 36, minSdk 26 |
| Apple | Bundle-ID `com.skydown.ios`, Build `10021`, Mac Catalyst im Xcode-Projekt aktiviert |
