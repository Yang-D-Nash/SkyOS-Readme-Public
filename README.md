...
| Android | `applicationId` `com.nash.skyos`, `versionCode` `10021`, SDK 36, minSdk 26 |
| Apple | Bundle-ID `com.skydown.ios`, Build `10020`, Mac Catalyst im Xcode-Projekt aktiviert |
