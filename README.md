...
- Android Adaptive: `mipmap-anydpi/ic_launcher*.xml` + `drawable/ic_launcher_foreground.xml` (Bitmap `gravity=fill` + Android-gepaddeter Foreground — Inset **klein** halten, sonst wirkt ein rundes Motiv im Launcher winzig)
