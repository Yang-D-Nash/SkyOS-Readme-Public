...
| Android | `applicationId` `com.nash.skyos`, `versionCode` `10025`, SDK 36, minSdk 26 |
| Apple | Bundle-ID `com.skydown.ios`, Build `10023`, Mac Catalyst im Xcode-Projekt aktiviert |
| Backend | Firebase Functions in `us-central1`, 64 Exports laut `npm run list-exports --prefix functions` |
| Interner Store-Test | iOS Build `10023` am 2026-05-05 zu App Store Connect hochgeladen; Android versionCode `10025` am 2026-05-05 zu Google Play Internal Testing als Draft hochgeladen |
