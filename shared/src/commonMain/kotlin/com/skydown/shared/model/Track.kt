...
fun sampleTracks(): List<Track> = listOf(
    Track(
        ...
        spotifyTrackId = "sample-track-id-1",
        ...
        externalUrl = "https://open.spotify.com/track/sample-track-id-1",
        wrapperType = "track",
    ),
    Track(
        trackId = 2,
        artistId = 1637910017,
        spotifyArtistId = "sample-artist-id-1",
        spotifyTrackId = "sample-track-id-2",
        artistName = "Yang D. Nash",
        ...
        externalUrl = "https://open.spotify.com/track/sample-track-id-2",
        wrapperType = "track",
    ),
    Track(
        trackId = 3,
        ...
        spotifyTrackId = "sample-track-id-3",
        artistName = "ThaDude",
        ...
        externalUrl = "https://open.spotify.com/track/sample-track-id-3",
        wrapperType = "track",
    ),
)
